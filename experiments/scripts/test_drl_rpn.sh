...
case ${DATASET} in
  pascal_voc_0712_test)
    ...
    ;;
  paris)
    WEIGHTS_PATH=/home/vador/Documents/project/AI/drl-rpn-tf/output-weights/drl-rpn-paris-video/output/vgg16_drl_rpn/paris_train/vgg16_drl_rpn_iter_1000.ckpt
    ;;
  *)
