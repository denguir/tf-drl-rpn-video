...
case ${DATASET} in
  ...
  paris)
    ...
    case ${USE_POST} in
      0)
        WEIGHTS_PATH=/home/vador/Documents/project/AI/drl-rpn-tf/data/pre-trained/drl-rpn-voc2007-2012-trainval-plus-2007test-video/vgg16_2012_drl_rpn_iter_0.ckpt
        ;;
      *)
